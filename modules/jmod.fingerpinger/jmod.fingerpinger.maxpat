...
,
						...
						"bglocked" : 0,
						"defrect" : [ 646.0, 50.0, 480.0, 360.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 551.0, 337.0, 291.0, 31.0 ],
					"text" : "jcom.message start @type boolean @range/clipmode both @description \"start trackpad polling\"",
