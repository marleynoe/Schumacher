...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 406.0, 476.0, 55.0, 19.0 ],
					"text" : "jcom.out"
				}
...
, 			{
				"box" : 				{
					"annotation" : "multitouch device number",
					"fontname" : "Verdana",
					"fontsize" : 8.0,
					"id" : "obj-12",
					"maxclass" : "number",
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 465.0, 258.0, 48.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 208.0, 19.0, 28.0, 16.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 526.25, 258.0, 411.0, 31.0 ],
					"text" : "jcom.parameter device @type integer @range/clipmode low @description \"multitouch device number\" @range/bounds 1 10 @value/default 1 @priority 1",
					"varname" : "driver/start[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 673.0, 412.0, 33.0, 19.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 487.0, 394.0, 37.0, 19.0 ],
					"text" : "== 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 779.0, 403.0, 201.0, 19.0 ],
					"text" : "jcom.return framesync @type generic",
					"varname" : "bend.5[8]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 729.0, 565.0, 109.0, 19.0 ],
					"text" : "jcom.fingerpinger 5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 715.0, 542.0, 109.0, 19.0 ],
					"text" : "jcom.fingerpinger 4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 701.0, 520.0, 109.0, 19.0 ],
					"text" : "jcom.fingerpinger 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 687.0, 498.0, 109.0, 19.0 ],
					"text" : "jcom.fingerpinger 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 673.0, 476.0, 109.0, 19.0 ],
					"text" : "jcom.fingerpinger 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 673.0, 437.0, 86.5, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 469.504883, 209.0, 40.990234, 20.15332 ],
					"presentation" : 1,
					"presentation_rect" : [ 236.0, 20.0, 59.487606, 14.15332 ],
					"rounded" : 8.0,
					"text" : "Start",
					"texton" : "Stop"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 687.0, 380.0, 111.0, 19.0 ],
					"text" : "jalg.fingerpinger #0"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 502.0, 506.0, 418.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 108.0, 82.0, 418.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 489.0, 482.0, 458.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 110.0, 55.0, 458.0, 18.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"patching_rect" : [ 82.0, 79.0, 49.0, 20.0 ],
													"text" : "t clear i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 268.0, 72.0, 93.0, 20.0 ],
													"text" : "route data sync"
												}
...
, 											{
												"patchline" : 												{
													...
													"disabled" : 0,
													"hidden" : 0,
													"midpoints" : [ 314.5, 112.5, 1001.5, 112.5 ],
													"source" : [ "obj-1", 1 ]
												}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 65.0, 219.0, 480.0, 360.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 0.0, 480.0, 360.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 82.0, 93.0, 77.0, 20.0 ],
									"text" : "r #0-drawing"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 489.0, 457.0, 60.0, 20.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 67.0, 64.0, 35.0, 20.0 ],
									"text" : "== 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 503.0, 544.0, 69.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 67.0, 118.0, 34.0, 20.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 67.0, 41.0, 155.0, 20.0 ],
									"text" : "jcom.oscroute /freeze /start"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 67.0, 3.0, 25.0, 25.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 144.5, 88.0, 35.5, 88.0 ],
									"source" : [ "obj-12", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 1,
									"midpoints" : [ 35.5, 216.0, 74.5, 216.0 ],
									"source" : [ "obj-3", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.0, 24.0, 62.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 152.0, 19.0, 65.0, 19.0 ],
					"text" : "device Nr."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 406.0, 346.0, 48.0, 19.0 ],
					"text" : "jcom.in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 274.0, 276.0, 113.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 221.0, 254.0, 76.0, 17.0 ],
					"text" : "/preset/write"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 166.0, 184.0, 137.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.0, 234.0, 157.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 11.0, 309.0, 533.0, 19.0 ],
					"text" : "jcom.hub @description \"Module for fingerpinger from [anyma | research ]  aka Michael and Max Egger\"",
					"varname" : "jcom.hub"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 259.0, 21.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 377.0, 21.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 181.0, 209.0, 199.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 406.0, 421.0, 49.0, 19.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "open" ],
					"patching_rect" : [ 406.0, 397.0, 41.0, 19.0 ],
					"text" : "t open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 406.0, 373.0, 183.0, 19.0 ],
					"text" : "jcom.oscroute /view/panel /freeze"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 526.25, 209.0, 376.0, 19.0 ],
					"text" : "jcom.message start @type boolean @description \"start trackpad polling\"",
					"varname" : "driver/start"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 230.5, 296.0, 20.5, 296.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 175.5, 296.0, 20.5, 296.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 210.5, 296.0, 20.5, 296.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 20.5, 348.0, 272.5, 348.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 20.5, 336.0, 366.0, 336.0, 366.0, 445.0, 415.5, 445.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 190.5, 296.0, 20.5, 296.0 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 283.5, 296.5, 20.5, 296.5 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 415.5, 367.0, 696.5, 367.0 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jalg.fingerpinger.maxpat",
				"bootpath" : "/Users/nilspeters/Documents/gits/Jamoma/UserLib/Schumacher/modules/jmod.fingerpinger",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "jcom.fingerpinger.maxpat",
				"bootpath" : "/Users/nilspeters/Documents/gits/Jamoma/UserLib/Schumacher/modules/jmod.fingerpinger",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
